...
public class Replit024_PatientInformation_Scanner {
...
Married?: true
        ...
        long personIPhoneNumber=scan.nextLong();
        ...
        String contacts="work phone number - "+workPhoneNumber+", personal phone number - "+personIPhoneNumber+", email: "+email;
